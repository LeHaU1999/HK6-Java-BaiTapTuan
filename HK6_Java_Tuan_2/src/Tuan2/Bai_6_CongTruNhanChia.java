...
public class Bai_6_CongTruNhanChia extends JFrame {

	public Bai_6_CongTruNhanChia(String title) {
		setTitle(title);
	}
	...
	public static void main(String[] args) {
		...
		Bai_6_CongTruNhanChia ui = new Bai_6_CongTruNhanChia("Cộng - Trừ - Nhân - Chia");
		ui.doShow();
	}
